...
class UpdateCourtCaseRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'case_no' => 'required|string|max:255|unique:court_cases,case_no,'.$this->court_case->id,
            'case_file_no' => 'required|string|max:255|unique:court_cases,case_file_no,'.$this->court_case->id,
            ...
            'case_categories.*' => 'integer|exists:court_case_categories,id',
        ];
    }
